"""
Django settings for ibartionmap project.
...
WSGI_APPLICATION = 'ibartionmap.wsgi.application'
...
MEDIA_ROOT = '/home/clientesgrupobtp/public_html/dev/media/'  # os.path.join(BASE_DIR, "media")
...
ASGI_APPLICATION = "ibartionmap.asgi.application"
